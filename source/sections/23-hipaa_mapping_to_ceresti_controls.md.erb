# 23. HIPAA Mappings to Ceresti Controls

Below is a list of HIPAA Safeguards and Requirements and the Ceresti controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Ceresti Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Ceresti Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Ceresti Control
---------------- | ----------------
