...
* *Application*: An application hosted by Ceresti, either maintained and created by Ceresti.
...
* *Customers*: Contractually bound users of Ceresti Platform.
...
* *Event*: An event is defined as an occurrence that does not constitute a serious adverse effect on Ceresti, its operations, or its Customers, though it may be less than optimal. Examples of events include, but are not limited to:
...
* *Logging Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Ceresti Add-ons and as an option for PaaS Customers.
...
* *Organization*: For the purposes of this policy, the term "organization" shall mean Ceresti.

* *Partner*: Contractual bound 3rd party vendor with integration with the Ceresti Platform. May offer Add-on services.

* *Platform*: The overall technical environment of Ceresti.
...
* *Security Incident* (or just Incident): A security incident is an occurrence that exercises a significant adverse effect on people, process, technology, or data. Security incidents include, but are not limited to:
  ...
  * Unauthorized change or destruction of ePHI (i.e. delete dictation, data alterations not following Ceresti's procedures);
  ...
  * Other examples of observable information security incidents may include, but are not limited to:
    ...
    * Terminated employee accessing applications, systems, or network.
...
* *Vendors*: Persons from other organizations marketing or selling products or services, or providing services to Ceresti.
